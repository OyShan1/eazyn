                  ...
                  <table class="table text-nowrap mb-0 align-middle">
                    ...
                    <tbody>
                      <?php
                        ...
                        ?>
                      <tr>
                        <td class="border-bottom-0"><h6 class="fw-semibold mb-0"><?php echo $data[0] ?></h6></td> <!-- adalah urutan field di database -->
                    ...
                    <div class="row align-items-center">
                      <div class="col-2">
                        <?php
                          ...
                          $query2 = "select count(id) as jumlah_izin from izin where siswa_id = 2 and is_approve=2";
